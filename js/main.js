 ...
 */
  ...
  if (0){ //Math.floor(Math.random()+0.5)
    ...
    console.log("|                                                                 |");
    console.log(" |                 If by Life You Were Deceived                    |");
    console.log(" |                       —— Aleksandr Pushkin                      |");
    console.log(" |                \"If by Life You Were Deceived,                   |");
    console.log("  |                  Don't be dismal, don't be wild!                |");
    console.log("  |                 In the day of grief, be mild,                   |");
    console.log("  |                  Merry days will come, believe.                 |");
    console.log("  |                 Heart is living in tomorrow,                     |");
    console.log("   |                  Present is dejected here,                      |");
    console.log("   |                In a moment, passes sorrow,                      |");
    console.log("   |                 That which passes will be dear.\"               |");
    console.log("  |                                                                 | ");
    ...
    console.log("𝒟𝓸𝓃'𝓉 𝒷𝓮 𝒹𝒾𝓈𝓂𝒶𝓁 ,𝒹𝓸𝓃'𝓉 𝒷𝓮 𝓌𝒾𝓁𝒹");
    console.log("𝓘𝓃 𝓉𝒽𝓮 𝒹𝒶𝓎 𝓸𝒻 𝓰𝓇𝒾𝓮𝒻 ,𝒷𝓮 𝓂𝒾𝓁𝒹");
    console.log("𝓜𝓮𝓇𝓇𝓎 𝒹𝒶𝓎𝓈 𝓌𝒾𝓁𝓁 𝒸𝓸𝓂𝓮, 𝒷𝓮𝓁𝒾𝓮𝓋𝓮");
    console.log("");
    console.log("𝓗𝓮𝒶𝓇𝓉 𝒾𝓈 𝓁𝒾𝓋𝒾𝓃𝓰 𝒾𝓃 𝓉𝓸𝓂𝓸𝓇𝓇𝓸𝓌");
    console.log("𝒫𝓇𝓮𝓈𝓮𝓃𝓉 𝒾𝓈 𝒹𝓮𝒿𝓮𝒸𝓉𝓮𝒹 𝒽𝓮𝓇𝓮");
    console.log("𝓘𝓃 𝒶 𝓂𝓸𝓂𝓮𝓃𝓉 ,𝓅𝒶𝓈𝓈𝓮𝓈 𝓈𝓸𝓇𝓇𝓸𝓌");
    console.log("𝒯𝒽𝒶𝓉 𝓌𝒽𝒾𝒸𝒽 𝓅𝒶𝓈𝓈𝓮𝓈 𝓌𝒾𝓁𝓁 𝒷𝓮 𝒹𝓮𝒶𝓇.");
  }
})
